...
<br/>
	...
	print $ih->button(t('Cancel'), $this->url('/dashboard/easy_news/manage'), 'left');
	...
	<?php   } else { ?>
		...
		<table border="0" class="ccm-results-list" cellspacing="0" cellpadding="8">
			<tr>
			...
			<tr>
				...
				<td><A href="<?php  echo $this->url('/dashboard/easy_news/manage', 'edit', $cobj->getCollectionID())?>"><?php  echo t('Edit')?></a></td>
				<td><A href="<?php  echo $this->url('/dashboard/easy_news/manage', 'delete', $cobj->getCollectionID())?>"><?php  echo t('Delete')?></a></td>
			</tr>
			<?php   } ?>
