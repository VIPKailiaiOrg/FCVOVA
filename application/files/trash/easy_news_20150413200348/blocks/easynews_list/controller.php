<?php
namespace Concrete\Package\EasyNews\Block\EasynewsList;
use \Concrete\Core\Block\BlockController;
use Concrete\Package\EasyNews\Models\EasyNewsController as EasyNewsController;
use Loader;
use Page;
	...
	class Controller extends BlockController {
		...
		var $num, $cParentID, $cThis, $orderBy, $ctID, $rss;
